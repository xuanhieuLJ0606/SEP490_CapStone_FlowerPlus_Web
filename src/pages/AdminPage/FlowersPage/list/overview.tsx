...
import { useGetFlowersByPaging } from '@/queries/flowers.query';
...
export function OverViewTab() {
  ...
  const { data: res, isPending } = useGetFlowersByPaging(page, pageLimit);
  ...
  return (
    <div className="grid gap-6 rounded-md p-4 pt-0 ">
      <h1 className="text-center font-bold">DANH SÁCH FLOWERS</h1>
      {isPending ? (
        <div className="p-5">
          <DataTableSkeleton
            columnCount={8}
