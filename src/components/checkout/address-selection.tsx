      ...
      <Dialog open={openDialog} onOpenChange={setOpenDialog}>
        <DialogPortal>
          ...
          <DialogPrimitive.Content
            className={cn(
              'fixed left-[50%] top-[50%] z-[110] grid max-h-[80vh] w-full max-w-2xl translate-x-[-50%] translate-y-[-50%] gap-4 overflow-y-auto border bg-background p-6 shadow-lg duration-200 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[state=closed]:slide-out-to-left-1/2 data-[state=closed]:slide-out-to-top-[48%] data-[state=open]:slide-in-from-left-1/2 data-[state=open]:slide-in-from-top-[48%] sm:rounded-lg'
            )}
          >
            <DialogHeader>
                    ...
                    <CardContent className="space-y-4 p-6">
                      <div>
                        ...
                        <p className="mt-1 text-sm text-gray-600">
                          Địa chỉ sẽ được lưu vào tài khoản của bạn để sử dụng
                          cho các lần đặt hàng sau
                        </p>
                      </div>
